...
export class TooManyRequestsError extends Error {
  constructor(message, resetAt) {
    super(
      message ||
        'تعداد درخواست‌های امروز شما به Genie به پایان رسیده. کمی بعد دوباره امتحان کن.'
    )
    this.name = 'TooManyRequestsError'
    this.resetAt = resetAt ?? null // epoch ms — تقریبی، وقتی قدیمی‌ترین درخواست از پنجره ۲۴ ساعته خارج می‌شود
  }
}